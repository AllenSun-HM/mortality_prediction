...
class TransformerBatchNormEncoderLayer(nn.modules.Module):
    ...
    def forward(self, src: Tensor, src_mask: Optional[Tensor] = None,
        ...
        Args:
            ...
            src_mask: the mask for the timeseries_transformer sequence (optional).
            src_key_padding_mask: the mask for the timeseries_transformer keys per batch (optional).
        ...
        # timeseries_transformer = timeseries_transformer.reshape([timeseries_transformer.shape[0], -1])  # (batch_size, seq_length * d_model)
        src = self.norm1(src)
...
class TSTransformerEncoderClassiregressor(nn.Module):
    ...
    def __init__(self, feat_dim, max_len, d_model, n_heads, num_layers, dim_feedforward, num_classes,
                 dropout=0.1, pos_encoding='fixed', activation='gelu', norm='BatchNorm', freeze=False, output_embedding=False):
        ...
        self.should_output_embedding = output_embedding
    ...
    def forward(self, X, padding_masks):
        ...
        if self.should_output_embedding:
            return output
