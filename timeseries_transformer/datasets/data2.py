...
class MimicData(BaseData):
    ...
    """
    imputed_values_df = pd.read_csv('/Users/allen/Desktop/mvts_transformer/src/resources/variable_ranges.csv',
                                    index_col=['LEVEL2'])

    def __init__(self, root_dir, file_list=None, pattern=None, n_proc=1, limit_size=None, config=None, labels_path=None):
