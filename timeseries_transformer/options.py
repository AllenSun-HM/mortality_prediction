...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--norm_mean_from',
        ...
        self.parser.add_argument('--weights', type=str, default='1.0,1.0',
                                 help='Transduction: Comma separated string of indices corresponding to features to be masked')
        ...
        self.parser.add_argument('--key_metric', choices={'loss', 'accuracy', 'precision', 'AUROC'}, default='loss',
    ...
    def parse(self):
        ...
        args.weights = [float(i) for i in args.lr_factor.split(',')]
