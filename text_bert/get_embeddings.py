...
mp_train_df = pd.read_csv('./MP_IN_adm_train.csv')
mp_val_df = pd.read_csv('./MP_IN_adm_val.csv')
mp_train_df = mp_train_df[mp_train_df['id'].isin(set(train_list_df['HADM_ID']))]
mp_val_df = mp_val_df[mp_val_df['id'].isin(set(val_list_df['HADM_ID']))]
